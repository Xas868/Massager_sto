...
INSERT INTO comment (id, comment_type, last_redaction_date, persist_date, text, user_id) VALUES
    (101, 0, DATE(NOW()), DATE(NOW()), 'Random CommentAnswer 1', 102),
    (102, 0, DATE(NOW()), DATE(NOW()), 'Random CommentAnswer 2', 102),
    (103, 1, DATE(NOW()), DATE(NOW()), 'Random CommentQuestion 1', 102),
    (104, 1, DATE(NOW()), DATE(NOW()), 'Random CommentQuestion 2', 102);
