...
INSERT INTO votes_on_questions (id, persist_date, vote, question_id, user_id) VALUES
    (201, DATE(NOW()),'UP_VOTE', 101, 101),
    (202, DATE(NOW()),'UP_VOTE', 101, 102),
    (203, DATE(NOW()),'UP_VOTE', 101, 103),
    (204, DATE(NOW()),'UP_VOTE', 101, 104),
    (205, DATE(NOW()),'UP_VOTE', 102, 105),
    (206, DATE(NOW()),'UP_VOTE', 102, 106),
    (207, DATE(NOW()),'UP_VOTE', 102, 107),
    (208, DATE(NOW()),'UP_VOTE', 103, 108);
