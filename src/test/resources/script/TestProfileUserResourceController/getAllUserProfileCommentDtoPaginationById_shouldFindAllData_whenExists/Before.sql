...
INSERT INTO comment (id, comment_type, last_redaction_date, persist_date, text, user_id) VALUES
    ...
    (103, 0, DATE(NOW()), DATE(NOW()), 'Random CommentAnswer 3', 101),
    (104, 0, DATE(NOW()), DATE(NOW()), 'Random CommentAnswer 4', 101),
    (105, 0, DATE(NOW()), DATE(NOW()), 'Random CommentAnswer 5', 101),
    (106, 1, DATE(NOW()), DATE(NOW()), 'Random CommentQuestion 1', 101),
    (107, 1, DATE(NOW()), DATE(NOW()), 'Random CommentQuestion 2', 101),
    (108, 1, DATE(NOW()), DATE(NOW()), 'Random CommentQuestion 3', 101),
    (109, 1, DATE(NOW()), DATE(NOW()), 'Random CommentQuestion 4', 101),
    (110, 1, DATE(NOW()), DATE(NOW()), 'Random CommentQuestion 5', 101);
