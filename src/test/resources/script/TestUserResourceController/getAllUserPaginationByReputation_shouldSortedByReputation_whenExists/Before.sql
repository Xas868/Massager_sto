...
INSERT INTO user_entity (id, about, city, email, full_name, image_link, is_deleted, is_enabled, last_redaction_date,
    ...
    null, null, null, 'user_101', '$2a$10$fyHD1Ut8.knrIds5S7/ee.Q5S5c.NQ3sr8k0YzUXsitEbGK.a7JZi', DATE(NOW()), 102),

    (102, 'I am test user', 'Moscow', 'user102@mail.ru', 'User 102', '/images/noUserAvatar.png', false, true, DATE(NOW()),
    null, null, null, 'user_102', '$2a$10$fyHD1Ut8.knrIds5S7/ee.Q5S5c.NQ3sr8k0YzUXsitEbGK.a7JZi', DATE(NOW()), 101),

    (103, 'I am test user', 'Moscow', 'user103@mail.ru', 'User 103', '/images/noUserAvatar.png', false, true, DATE(NOW()),
     null, null, null, 'user_103', '$2a$10$EMnv6R2rQeKo1ih75/vr2OW.WKVDHVIvtQ/50w4brxSjBWOi.gMqS', DATE(NOW()), 101),

    (104, 'I am test user', 'Moscow', 'user104@mail.ru', 'User 104', '/images/noUserAvatar.png', false, true, DATE(NOW()),
     null, null, null, 'user_104', '$2a$10$TTYhwHF1QXxMV5UekMMuhudbNtVtJUwytwY4p4iaOmC0Ob4Lo0Yp.', DATE(NOW()), 101),

    (105, 'I am test user', 'Moscow', 'user105@mail.ru', 'User 105', '/images/noUserAvatar.png', false, true, DATE(NOW()),
     null, null, null, 'user_105', '$2a$10$Dhv/NrypItLBzxl0ZEr/euSDZ5p6gs1qlQSI7SCrWggi8kCFLWBw6', DATE(NOW()), 101),

    (106, 'I am test user', 'Moscow', 'user106@mail.ru', 'User 106', '/images/noUserAvatar.png', false, true, DATE(NOW()),
     null, null, null, 'user_106', '$2a$10$6FqiClazINIE4C.Te46ah.njD84Uh92M0ThrIFf2FswBrDjk9Sofa', DATE(NOW()), 102),

    (107, 'I am test user', 'Moscow', 'user107@mail.ru', 'User 107', '/images/noUserAvatar.png', false, true, DATE(NOW()),
     null, null, null, 'user_107', '$2a$10$xRacvUEmfsRdsP8aBy1/Y.d9j3c4u7wInOEKb5hQlQSgsgT6tnw8W', DATE(NOW()), 102),

    (108, 'I am test user', 'Moscow', 'user108@mail.ru', 'User 108', '/images/noUserAvatar.png', false, true, DATE(NOW()),
     null, null, null, 'user_108', '$2a$10$xZPFM9fGuVNOTpM1Amcyf.XYsm27ghtyycsHQXSqhC3YkUIkwmFL2', DATE(NOW()), 102),

    (109, 'I am test user', 'Moscow', 'user109@mail.ru', 'User 109', '/images/noUserAvatar.png', false, true, DATE(NOW()),
     null, null, null, 'user_109', '$2a$10$A4XPUipJCy98CZgxOtFEtOyMBhOoPxVyAUYxXFHhVYThyV79Xwh62', DATE(NOW()), 102),

    (110, 'I am test user', 'Moscow', 'user110@mail.ru', 'User 110', '/images/noUserAvatar.png', false, true, DATE(NOW()),
     null, null, null, 'user_110', '$2a$10$xrlkNgwqtuCR5dszNG/yEOp5QffdvpAxYD.gCY70YVi4uogJYdQVu', DATE(NOW()), 102);
...
INSERT INTO question (id, description, is_deleted, last_redaction_date, persist_date, title, user_id) VALUES
    ...
    (102, 'What do you think about question 102?', false, DATE(NOW()), DATE(NOW()), 'Question 102', 108),
...
INSERT INTO reputation (id, count, persist_date, type, answer_id, author_id, question_id, sender_id) VALUES
    ...
    (102, 9000, DATE(NOW()), 0, null, 103, 102, null),
    (103, 800, DATE(NOW()), 0, null, 102, 103, null),
    (104, 700, DATE(NOW()), 0, null, 104, 104, null),
    (105, 600, DATE(NOW()), 0, null, 107, 101, null),
    (106, 500, DATE(NOW()), 0, null, 106, 102, null),
    (107, 400, DATE(NOW()), 0, null, 105, 103, null),
    (108, 300, DATE(NOW()), 0, null, 110, 104, null),
    (109, 200, DATE(NOW()), 0, null, 109, 103, null),
    (110, 100, DATE(NOW()), 0, null, 108, 104, null),
    (111, 6000, DATE(NOW()), 0, null, 107, 101, null),
    (112, 500, DATE(NOW()), 0, null, 106, 102, null),
    (113, 4500, DATE(NOW()), 0, null, 105, 103, null),
    (114, 3000, DATE(NOW()), 0, null, 110, 104, null),
    (115, 200, DATE(NOW()), 0, null, 109, 103, null),
    (116, 100, DATE(NOW()), 0, null, 108, 104, null);