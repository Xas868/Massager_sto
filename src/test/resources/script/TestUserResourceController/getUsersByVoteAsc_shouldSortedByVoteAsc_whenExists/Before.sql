...
INSERT INTO reputation (id, count, persist_date, type, answer_id, author_id, question_id, sender_id) VALUES
    ...
    (111, 1000, DATE(NOW()), 3, null, 110, null, null),
    (112, 10000, DATE(NOW()), 3, null, 110, null, null),
    (113, 2000, DATE(NOW()), 2, null, 109, null, null),
    (114, 2000, DATE(NOW()), 2, null, 109, null, null);
