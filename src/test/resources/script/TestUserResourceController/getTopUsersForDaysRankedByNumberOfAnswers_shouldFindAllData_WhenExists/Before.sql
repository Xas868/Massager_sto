...
INSERT INTO question (id, description, is_deleted, last_redaction_date, persist_date, title, user_id) VALUES
    (101, 'What do you think about question 101?', false, DATE(NOW()), DATE(NOW()), 'Question 101', 103),
 ...
 *  Table: answer
    Top 3 users:
    1. user110. Count of answers: 4
    2. user101. Count of answers: 3
    3. user102. Count of answers: 1
    Total count of answers in rating list: 10
 */
INSERT INTO answer (id, date_accept_time, html_body, is_deleted, is_deleted_by_moderator, is_helpful, persist_date,
    ...
    (102, DATE(NOW()), 'Answer 102', false, false, false, DATE(NOW()), DATE(NOW()), 102, 110, null),
    (103, DATE(NOW()), 'Answer 103', false, false, false, DATE(NOW()), DATE(NOW()), 103, 110, null),
    (104, DATE(NOW()), 'Answer 104', false, false, false, DATE(NOW()), DATE(NOW()), 104, 110, null),
    (105, DATE(NOW()), 'Answer 105', false, false, false, DATE(NOW()), DATE(NOW()), 101, 101, null),
    (106, DATE(NOW()), 'Answer 106', false, false, false, DATE(NOW()), DATE(NOW()), 102, 101, null),
    (107, DATE(NOW()), 'Answer 107', false, false, false, DATE(NOW()), DATE(NOW()), 103, 101, null),
    (108, DATE(NOW()), 'Answer 108', false, false, false, DATE(NOW()), DATE(NOW()), 104, 102, null),
    (109, DATE(NOW()), 'Answer 101', false, false, false, DATE(NOW()), DATE(NOW()), 101, 103, null),
    (110, DATE(NOW()), 'Answer 102', false, false, false, DATE(NOW()), DATE(NOW()), 102, 104, null),
    (111, DATE(NOW()), 'Answer 103', false, false, false, DATE(NOW()), DATE(NOW()), 103, 105, null),
    (112, DATE(NOW()), 'Answer 104', false, false, false, DATE(NOW()), DATE(NOW()), 104, 106, null),
    (113, DATE(NOW()), 'Answer 105', false, false, false, DATE(NOW()), DATE(NOW()), 101, 107, null),
    (114, DATE(NOW()), 'Answer 106', false, false, false, DATE(NOW()), DATE(NOW()), 102, 108, null),
    (115, DATE(NOW()), 'Answer 107', false, false, false, DATE(NOW()), DATE(NOW()), 103, 109, null);
