...
INSERT INTO user_entity (id, about, city, email, full_name, image_link, is_deleted, is_enabled, last_redaction_date,
    ...
    (103, 'I am test user', 'Moscow', 'adminmail103@mail.ru', 'Admin 103', '/images/noUserAvatar.png', false, true, DATE(NOW()),
    null, null, null, 'admin_103', '$2a$10$EMnv6R2rQeKo1ih75/vr2OW.WKVDHVIvtQ/50w4brxSjBWOi.gMqS', '2022-11-12 17:55:55.461886', 101),

    (104, 'I am test user', 'Moscow', 'adminmail104@mail.ru', 'Admin 104', '/images/noUserAvatar.png', false, true, DATE(NOW()),
    null, null, null, 'admin_104', '$2a$10$TTYhwHF1QXxMV5UekMMuhudbNtVtJUwytwY4p4iaOmC0Ob4Lo0Yp.', '2022-10-12 17:55:55.461886', 101),

    (105, 'I am test user', 'Moscow', 'adminmail105@mail.ru', 'Admin 105', '/images/noUserAvatar.png', false, true, DATE(NOW()),
    null, null, null, 'admin_105', '$2a$10$Dhv/NrypItLBzxl0ZEr/euSDZ5p6gs1qlQSI7SCrWggi8kCFLWBw6', '2022-05-12 17:55:55.461886', 101),
...
INSERT INTO reputation (id, count, persist_date, type, answer_id, author_id, question_id, sender_id) VALUES
    ...
    (109, 2000, DATE(NOW()), 2, null, 105, 101, null),
    (110, 100, DATE(NOW()), 3, null, 102, 102, null),
    (111, 1000, DATE(NOW()), 3, null, 102, null, null),
    (112, 10000, DATE(NOW()), 3, null, 103, null, null),
    (113, 2000, DATE(NOW()), 2, null, 103, null, null),
    (114, 2000, DATE(NOW()), 2, null, 103, null, null);