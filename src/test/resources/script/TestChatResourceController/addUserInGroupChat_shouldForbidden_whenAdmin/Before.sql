...
INSERT INTO user_entity (id, about, city, email, full_name, image_link, is_deleted, is_enabled, last_redaction_date,
    ...
    (123, 'I am test user', 'Moskow', 'user123@mail.ru', 'User 123', '/images/noUserAvatar.png', false, true, DATE(NOW()),
     null, null, null, 'user_123', '$2a$10$koRWhTJc7d.cBeLbKhln0O6wGXa64lJwiOTd8KYyarcVjmMbktpcW', DATE(NOW()), 101);
...
INSERT INTO group_chat (chat_id, title, author_id, image) VALUES
    (101, 'GroupChat 101', 122, 'image 101');
