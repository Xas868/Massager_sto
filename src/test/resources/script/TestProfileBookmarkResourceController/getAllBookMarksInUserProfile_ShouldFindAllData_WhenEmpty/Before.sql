...
INSERT INTO bookmarks (id, question_id, user_id, note) VALUES
    (101, 101, 104, 'title 101'),
    (102, 102, 105, 'title 102'),
    (103, 103, 107, 'title 103'),
    (104, 104, 102, 'title 104'),
    (105, 105, 103, 'title 105'),
    (106, 106, 106, 'title 106'),
    (107, 107, 107, 'title 107'),
    (108, 108, 108, 'title 108');
