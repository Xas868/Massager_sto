...
INSERT INTO bookmark_has_group (group_bookmark_id, book_marks_id) VALUES
 ...
 /*  Table: question_viewed
    Test data:
    question_id:108 - 4 views
    question_id:103 - 3 views
    question_id:102 - 1 view
 */


INSERT INTO question_viewed (id, persist_date, question_id, user_id) VALUES
    (201, DATE(NOW()), 108, 101),
    (202, DATE(NOW()), 108, 101),
    (203, DATE(NOW()), 108, 101),
    (204, DATE(NOW()), 108, 101),
    (205, DATE(NOW()), 103, 101),
    (206, DATE(NOW()), 103, 101),
    (207, DATE(NOW()), 103, 101),
    (208, DATE(NOW()), 102, 101);
