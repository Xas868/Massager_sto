...
VALUES (101, DATE(NOW()), 'Answer 101', false, false, false, DATE(NOW()), DATE(NOW()), 101, 103, null),
       (102, DATE(NOW()), 'Answer 102', false, false, false, DATE(NOW()), DATE(NOW()), 101, 104, null),
       (103, DATE(NOW()), 'Answer 103', false, false, false, DATE(NOW()), DATE(NOW()), 101, 101, null),
       (104, DATE(NOW()), 'Answer 104', false, false, false, DATE(NOW()), DATE(NOW()), 102, 102, null),
       (105, DATE(NOW()), 'Answer 105', false, false, false, DATE(NOW()), DATE(NOW()), 102, 105, null);
