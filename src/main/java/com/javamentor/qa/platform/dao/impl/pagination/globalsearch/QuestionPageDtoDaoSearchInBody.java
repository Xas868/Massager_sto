...
@Repository("QuestionPageDtoDaoSearchInBody")
public class QuestionPageDtoDaoSearchInBody implements PageDtoDao<QuestionViewDto> {
    ...
    public List<QuestionViewDto> getPaginationItems(PaginationData properties) {
        ...
        return entityManager.createQuery(
                ...
                .setParameter("q",((String) properties.getProps().get("q")).replaceAll("body:",""))
    ...
    public Long getTotalResultCount(Map<String, Object> properties) {
        ...
        return (Long) entityManager.createQuery("select distinct count(distinct q.id) from Question q WHERE " +
                        "lower(q.description) like lower(concat('%',:q,'%'))"
                )
                .setParameter("q", ((String)properties.get("q")).replaceAll("body:",""))
                .getSingleResult();
    }
}
